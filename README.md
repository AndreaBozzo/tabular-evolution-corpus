...
Corpus 0.2.0 at revision `cf6599a4995f`; DuckDB 1.5.5, Polars 1.44.2, PyArrow 25.0.1. Full records: [`duckdb.jsonl`](results/0.2.0/duckdb.jsonl), [`polars.jsonl`](results/0.2.0/polars.jsonl), [`pyarrow_dataset.jsonl`](results/0.2.0/pyarrow_dataset.jsonl).
